...
public class AlignDNARepeats {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < firstUsed.length(); i++) {
            ...
            compare(fr, srs, offset, "r" + i, i > 0 && (firstUsed.get(i) - 1 != firstUsed.get(i - 1)
                  || secondUsed.get(i) - 1 != secondUsed.get(i - 1)));
            offset += fr.getLength();
        }
    ...
    private static void compare(Sequence fn, Sequence[] sns, int offset, String type,
          boolean breakpoint) {
