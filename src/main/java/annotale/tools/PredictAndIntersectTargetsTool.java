...
public class PredictAndIntersectTargetsTool implements JstacsTool {
	...
	public String getHelpText() {
		try {
			return FileManager.readInputStream( TALEPredictionTool.class.getClassLoader().getResourceAsStream( "annotale/tools/PredictAndIntersectTargetsTool.txt" ) ).toString();
		} catch ( IOException e ) {
			e.printStackTrace();
			return "";
		}
