...
public class NHMMerLoose {
	...
	public static void main(String[] args) throws Exception {
		...
		Pair<AbstractHMM, HomogeneousMMDiffSM> repeats = HMMFactory.parseProfileHMMFromHMMer( new InputStreamReader( TALEPredictionTool.class.getClassLoader().getResourceAsStream( "annotale/data/repeats.hmm" ) ), repeatConsensus, null, null );
		...
		Pair<AbstractHMM, HomogeneousMMDiffSM> start = HMMFactory.parseProfileHMMFromHMMer( new InputStreamReader( TALEPredictionTool.class.getClassLoader().getResourceAsStream("annotale/data/starts.hmm")), startConsensus, startMatchStates, startSilentStates );
		...
		Pair<AbstractHMM, HomogeneousMMDiffSM> end = HMMFactory.parseProfileHMMFromHMMer( new InputStreamReader( TALEPredictionTool.class.getClassLoader().getResourceAsStream("annotale/data/ends.hmm")), endConsensus, endMatchStates, endSilentStates );
