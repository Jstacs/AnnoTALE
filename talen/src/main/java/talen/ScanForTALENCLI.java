...
public class ScanForTALENCLI {
	...
	public static void main( String[] args ) throws Exception {
		...
		if(mod.getValue().equals( "TALgetter" )){
			model = (TALgetterDiffSM)XMLParser.extractObjectForTags( FileManager.readInputStream( ScanForTALENCLI.class.getClassLoader().getResourceAsStream( "tals/talfinder_obg2_hyp_bg.xml" ) ), "model" );		
		}else{
			model = (TALgetter13DiffSM)XMLParser.extractObjectForTags( FileManager.readInputStream( ScanForTALENCLI.class.getClassLoader().getResourceAsStream( "tals/talfinder_obg2_hyp_bg_map.xml" ) ), "model" );
		}
