...
public class TALEPredictionTool implements JstacsTool {
	...
	public ToolResult run( ToolParameterSet parameters, Protocol protocol, ProgressUpdater progress, int threads ) throws Exception {
		...
		int[][] regions = NHMMer.run( new InputStreamReader( TALEPredictionTool.class.getClassLoader().getResourceAsStream( "annotale/data/repeats.hmm" ) ) , 
				new InputStreamReader( TALEPredictionTool.class.getClassLoader().getResourceAsStream("annotale/data/starts.hmm")), 
				new InputStreamReader( TALEPredictionTool.class.getClassLoader().getResourceAsStream("annotale/data/ends.hmm")), ds, progress, sensitive );
	...
	public String getHelpText() {
		try {
			return FileManager.readInputStream( TALEPredictionTool.class.getClassLoader().getResourceAsStream( "annotale/tools/TALEPredictionTool.txt" ) ).toString();
		} catch ( IOException e ) {
			e.printStackTrace();
			return "";
		}
